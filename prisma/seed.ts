    ...
    data: [
      {
        ...
        description: "Англійський гумор – річ, яка погано піддається перекладу, часто обурлива, інколи на межі здорового глузду. В британських комедіях майже немає заборонених тем. Смерть, потворність, релігія, королева, твоя власна персона – будь-яка тема годиться, аби було кумедно.",
      },
      {
        id: "betray-me",
        title: "Зрадь мене",
        ...
        duration: "2 год",
        description: "Драматургія Володимира Винниченка вирізняється роздумами над вічними проблемами буття, зради, моралі. Ця п’єса дозволяє переосмислити і задуматися над своїм ставленням до сім’ї, коханої чи коханого, особливо у ті хвилини життя, коли на терезах сімейного щастя постає вибір, – як зберегти своє кохання і не втратити сім’ю.",
      },
      {
        id: "gabriel",
        title: "Габріель",
        ...
        type: "комедія",
        duration: "1 год 30 хв",
        description: "Історія за п’єсою французької драматургині Мішель Лоранс. Франція, Париж і чотири жіночі долі на перехресті століття. Століття, яке в цей день святкує Габі. На ювілей зійшлися її дочка Марель, онука Ніна та правнучка Фостін – хвилююче танго чотирьох поколінь.",
      },
      {
        ...
        duration: "2 год",
        description: "Карпатські праліси та гори – місце дійства казкового марева. Коли вечірня роса вже впала на ожини і сови, що ночують на старих кладовищах, збираються на полювання — ніч починає заступати гори. Час сповільнює свій темп, здається, навіть гірські річки течуть спокійніше, а пастухи, дрімаючи біля ватри, слухають оповідання старих про чугайстрів, що нападають на худобу. Отоді в Карпатах починається найцікавіше.",
      },
      {
        ...
        duration: "2 год",
        description: "Театр ставить завдання нагадати людям про любов до ближнього, яка, як правило, все частіше у зв’язку з розвитком цивілізації, комфорту життя, а також матеріального достатку в житті людей стає дефіцитом, тому що люди часто настільки захоплюються власним збагаченням, що інколи не помічають тих, хто поруч, кому потрібна їх увага, любов і допомога.",
      },
      {
  ...
  const worker = await prisma.worker.createMany({
    data: [
      ...
      },
      {
        id: "yurij-marchak",
        name: "Юрій Марчак",
        position: "Директор, художній керівник театру",
        department: "management",
        bio: "Народився у селі Топорівка, Новоселицького району, Чернівецької області.  1984-го року закінчив Чернівецьке культосвітнє училище мистецтв.  1988-го року закінчив Київський державний інститут театрального мистецтва ім. Карпенка-Карого та здобув спеціальність актор драматичного театру і кіно.  Від 01.07.1988р. по 02.01.1992р. – актор драми Чернівецького облукрмуздрамтеатру імені О. Кобилянської.  02.01.1992р. – 20.03.1996р. – завідувач Міського віділу культури Чернівецького міськвиконкому.  Від 26.03.1996р. до 06.02.1997р. – актор драми, 1997-го року переведений на посаду директора-розпорядника театру.  2011-го року став лауреатом обласної літературно-мистецької премії імені С. Воробкевича у номінації «Театральне мистецтво».  2009-го року удостоєний почесного звання «Заслужений працівник культури України».  24 серпня 2016р. – нагороджений відзнакою Президента України та Ювілейною медаллю «25 років Незалежності України».  Актор, педагог, директор фестивалю комедії «Золоті оплески Буковини», театральної студії для дітей та молоді.",
      },
    ],
  });
    ...
    data: [
      {
        ...
        content: "Хто ми? Звідки? Чи куди йдемо? Сергій Винниченко театральний блогер, автор порталу “Театральна риболовля”. 18 червня, 12:00, фоє театру, 2-й поверх. Вхід вільний.",
      },
      {
        id: "see-you-in-the-new-theatrical-season",
        title: "До зустрічі у новому театральному сезоні",
        content: "Шановні глядачі, до зустрічі у новому 91-му театральному сезоні. З питань екскурсії, звертайтеся за телефоном (0372) 52-46-62.",
      },
      {
        id: "theatrical-event-white-bird-of-bukovina",
        title: "Театральна імпреза “Білий птах Буковини”",
        content: "15 червня, 11:00, театральна імпреза до 80-ї річниці з дня народження видатного українського кіномитця Івана Миколайчука. Театр просто неба в музеї-садибі села Чорториї. Вхід вільний.",
      },
      {
        id: "vidmina-vistav-u-zhovtni-2022",
        title: "Відміна вистав у жовтні 2022",
        content: "Шановні глядачі, повідомляємо про зміни в репертуарі на жовтень 2022 року, вистави з 7 по 10 жовтня - скасовано. Приносимо вибачання за незручності і дякуємо за розуміння.",
      },
    ],
  });
  ...
  const vacancy = await prisma.vacancy.createMany({
    data: [
      ...
      },
      {
        ...
        description: "Production designer of a theater and performance institution",
      },
    ],
  });
